...
function purchaseClicked() {
    ...
    for (var i = 0; i < cartItems.children.length; i++) {
        var cartRow = cartItems.children[i]
        ...
        var itemTotal = parseFloat(itemPrice.replace('$', '')) * itemQuantity
        
        // Append item details to the itemsList string
        itemsList += itemTitle + ' x ' + itemQuantity + ' = $' + itemTotal.toFixed(2) + '\n'
        
        // Add item total to the overall cart total
        total += itemTotal
    }
    
    // Display the item details and total cost in an alert message
